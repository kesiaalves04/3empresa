...
# pega caminho correto da pasta atual
...
# SPACE X
with col1:
    st.image(os.path.join(BASE_DIR, "espacox.png"), use_container_width=True)
    st.subheader("🚀 SpaceX")
...
# APPLE
with col2:
    st.image(os.path.join(BASE_DIR, "iphone.png"), use_container_width=True)
    st.subheader("🍎 Apple")
    st.write("Empresa mundial de tecnologia.")
    st.link_button("Acessar Site", "https://www.apple.com/br/")

# NETFLIX
with col3:
    st.image(os.path.join(BASE_DIR, "netflix.png"), use_container_width=True)
